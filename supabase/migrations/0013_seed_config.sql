...
insert into public.settings (key, value, description, is_public) values
  ...
  ('store_description',
   '"Bidyut is a Dhaka-based electronics retailer. Official-warranty phones, laptops, audio and smart home gear, delivered nationwide with cash on delivery."'::jsonb,
  ...
  ('support_email', '"support@bidyut.com.bd"'::jsonb, 'Customer support inbox', true),
  ...
  ('social_links',
   '{"facebook":"https://facebook.com/bidyutbd","instagram":"https://instagram.com/bidyutbd","youtube":"https://youtube.com/@bidyutbd"}'::jsonb,
...
values
  ...
  ('BIDYUT10', '10% off, up to ৳1,500 — sitewide',
