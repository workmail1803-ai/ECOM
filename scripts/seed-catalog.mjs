  ...
  if (withBanners) {
    ...
    const banners = [
      ...
      // rather than letterbox a landscape frame.
      {
        ...
        cta_href: "/products?category=headphone-and-earphone",
        accent_hex: "#6D28D9",
        priority: 100,
        is_active: true,
      },
      {
        ...
        cta_label: "Discover",
        cta_href: "/products?category=keyboard-and-mouse",
        accent_hex: "#1B4DFF",
        priority: 90,
        is_active: true,
      },
      {
        ...
        cta_label: "Explore",
        cta_href: "/products?category=ups-for-pc",
        accent_hex: "#0F766E",
        priority: 80,
        is_active: true,
      },
      {
        ...
        cta_label: "View",
        cta_href: "/products?category=consumer-electronics",
        accent_hex: "#B45309",
        priority: 50,
        is_active: true,
      },
      {
        ...
        cta_label: "Shop",
        cta_href: "/products?category=mobile-accessories",
        accent_hex: "#BE123C",
        priority: 45,
        is_active: true,
      },
      {
        ...
        cta_label: "Browse",
        cta_href: "/products?category=smart-home-iot",
        accent_hex: "#0369A1",
        priority: 40,
        is_active: true,
      },
